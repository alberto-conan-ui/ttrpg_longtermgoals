        ...
        <div className="space-y-4">
          ...
          {hasDiscord && (
            <a
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#5865F2] px-4 py-3 text-sm font-medium text-white shadow-sm hover:bg-[#4752C4] transition-colors"
            >
