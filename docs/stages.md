...
**Spec:** `docs/SPEC.md` (currently v0.13)
...
| UC-004 | Statement Allocation & Knowledge Building | Draft | [`UC-004-statement-allocation.md`](use-cases/UC-004-statement-allocation.md) |
| UC-005 | Full Session Prep (Stress Test) | Draft | [`UC-005-full-session-prep.md`](use-cases/UC-005-full-session-prep.md) |
| UC-006 | *(to be defined — likely: DM activates campaign, runs first session with players)* | — | — |
